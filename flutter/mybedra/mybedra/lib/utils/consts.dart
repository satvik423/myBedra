...
final connectblue = Color.fromARGB(255, 72, 195, 252);
final maroon = Color.fromARGB(255, 72, 195, 252);
final marooncolor = const Color(0xFFC2315C);
final marooncolorlight = Color.fromARGB(136, 198, 64, 104);
