...
class FoodScreenState extends State<FoodScreen> {
  ...
  Future<void> fetchData() async {
    ...
    final response = await http.get(Uri.parse(serverPath.url + 'food_fetch'));
  ...
  void addToCart(Map<String, dynamic> item) {
    ...
    final hotelName = item['hotel_name'];
                  ...
                  itemBuilder: (ctx, index) {
                    ...
                    return Card(
                      shape: RoundedRectangleBorder(
                          ...
                          side: BorderSide(color: OrangeDark)),
                      child: Column(
                        children: [
                          Padding(
...
class _CartScreenState extends State<CartScreen> {
  ...
  void sendOrderToAPI(List<Map<String, dynamic>> orderedItems) {
    ...
    final url = serverPath.url + 'food_ordered';
    http.post(
      Uri.parse(url),
      headers: {'Content-Type': 'application/json'},
